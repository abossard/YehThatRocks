...
export default async function AccountPage() {
  const [currentVideo, relatedVideos, user] = await Promise.all([
  ...
  return (
    <AppShell
      ...
      kicker="Account"
      title="User settings shell"
      description="The account route now sits on a secure session foundation and is ready for profile settings, password change, and avatar controls."
    >
